...
def getRoutes():
    ...
    if startpoint is None or endpoint is None:
        ...
        if pollutant is None:
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=foot&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='CO':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairaco&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='H2S':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairah2&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='NO2':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairano&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='O3':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairao3&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='PM10':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairapm1&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='PM25':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairapm2&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
        elif pollutant=='SO2':
            requestdijkstra="?point="+str(startpoint['lat'])+","+str(startpoint['lon'])+"&point="+str(endpoint['lat'])+","+str(endpoint['lon'])+"&type=json&locale=es-ES&elevation=false&profile=qairaso2&algorithm=dijkstra&use_miles=false"
            response=requests.get(routingUrl+requestdijkstra)
            return jsonify(response.json())
